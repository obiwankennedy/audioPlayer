...
Wizzardexport::Wizzardexport(PlayListViewer* p) : QDialog(p), view(p)
{
    setupUi(this);
...
void Wizzardexport::initAction()
{
    ...
    connect(
        listofallfield, SIGNAL(currentItemChanged(QListWidgetItem*, QListWidgetItem*)), this, SLOT(onChangedList()));
    connect(listofselectedfield, SIGNAL(currentItemChanged(QListWidgetItem*, QListWidgetItem*)), this,
        SLOT(onChangedList()));
}
