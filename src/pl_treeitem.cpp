...
#include <QDebug>
//
PL_treeitem::PL_treeitem(PlaylistItem* _item) : deep(NULL)
{
...
void PL_treeitem::appendChild(PlaylistItem* item, headerlistview* key)
{
    ...
    else
    {
        ...
        QMap<QString, PL_treeitem*>::Iterator q
            = childItems.insert(a->getMember(key->x).toString(), p); // replace this line to create new Pl_TreeItem
