 ...
 ***************************************************************************/
#ifndef SONGINTERFACE_H
#define SONGINTERFACE_H
...
class SongInterface
{
    ...
    public:
        ...
        virtual void SetSong(SongFields* p)=0;
        ...
        virtual void readSetting(QSettings& settings)=0;
        virtual void writeSetting(QSettings& settings)=0;
   public slots:
          virtual void show()=0;
...
Q_DECLARE_INTERFACE(SongInterface,"org.PlayListGenerator.SongInterface/1.0")
#endif
