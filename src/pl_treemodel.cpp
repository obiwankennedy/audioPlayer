...
#include <QDebug>
//
PL_TreeModel::PL_TreeModel() : QAbstractItemModel()
{
...
QVariant PL_TreeModel::headerData(int section, Qt::Orientation orientation, int role) const
{
...
QModelIndex PL_TreeModel::index(int row, int column, const QModelIndex& parent) const
{
...
bool PL_TreeModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
