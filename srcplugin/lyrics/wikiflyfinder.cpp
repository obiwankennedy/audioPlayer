...
WikiFlyFinder::WikiFlyFinder()
{
    ...
    QObject::connect(http, SIGNAL(finished(QNetworkReply*)), this, SLOT(readResponseHeader(QNetworkReply*)));
...
void WikiFlyFinder::search()
{
    ...
    QString url= QString("http://api.lyricsfly.com/api/api.php?i=09480e0551c7da949-lyricsfreelive.com&a=%1&t=%2")
                     .arg(fields->Artist)
                     .arg(fields->Title);
